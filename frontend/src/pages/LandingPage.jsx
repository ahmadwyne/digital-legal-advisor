...
//             <div className={`flex flex-col items-center gap-2 mb-2 ${isVisible ? "animate-fade-in" : "opacity-0"}`} style={{ animationDelay: "0.5s" }}>
...
//             {[
//               { icon: Shield, title: "Secure & Confidential", desc: "Enterprise-grade encryption protecting your sensitive legal data.", gradient: "from-blue-600 to-blue-700", delay: "0ms" },
//               { icon: Brain, title: "AI-Powered Intelligence", desc: "Trained specifically on Pakistani financial laws for accurate guidance.", gradient: "from-amber-600 to-orange-600", delay: "100ms" },
//               { icon: BookOpen, title: "Legal Encyclopedia", desc: "Instant access to thousands of case precedents and legal documents.", gradient: "from-indigo-600 to-purple-600", delay: "200ms" },
//             ].map((item, idx) => (
//               <div key={idx} className="group glass-effect p-8 rounded-3xl border-2 border-white/50 hover:border-blue-300 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 animate-slide-up" style={{ animationDelay: item.delay }}>
//                 <div className={`relative w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500`}>
//                   <item.icon className="w-8 h-8 text-white" strokeWidth={2.5} />
//                   <div className="absolute inset-0 bg-white/20 rounded-2xl animate-pulse"></div>
//                 </div>
//                 <h3 className="text-2xl font-bold text-gray-800 mb-3 group-hover:text-blue-700 transition-colors duration-300" style={{ fontFamily: "Poppins" }}>{item.title}</h3>
...
//             {[
//               { icon: Users, title: "Citizens", desc: "Everyday individuals needing legal clarity.", delay: "0ms" },
//               { icon: BookOpen, title: "Students", desc: "Law students bridging theory with practice.", delay: "100ms" },
//               { icon: Scale, title: "Professionals", desc: "Lawyers streamlining research.", delay: "200ms" },
//               { icon: Lock, title: "Firms", desc: "Agencies automating workflows.", delay: "300ms" },
//             ].map((item, idx) => (
//               <div key={idx} className="bg-white p-8 rounded-3xl border-2 border-gray-100 hover:border-blue-300 hover:shadow-2xl transition-all duration-500 transform hover:scale-110 group text-center animate-zoom-in" style={{ animationDelay: item.delay }}>
...
//         {/* WAVE AT BOTTOM */}
//         <div className="absolute bottom-0 left-0 w-full pointer-events-none">
//           <svg className="w-full" viewBox="0 0 1440 100" preserveAspectRatio="none" style={{ display: "block", height: "40px" }}>
//             <path d="M0,50 C360,100 720,0 1080,50 C1260,75 1350,100 1440,100 L1440,100 L0,100 Z" fill="#e0f2fe" />
//           </svg>
//         </div>
//       </section>
...
//       <div className="group glass-effect p-8 md:p-12 rounded-[2rem] border-2 border-blue-100 hover:border-blue-400 hover:shadow-2xl transition-all duration-500 animate-slide-in-left" style={{ animationDelay: "100ms" }}>
...
//       <div className="group glass-effect p-8 md:p-12 rounded-[2rem] border-2 border-blue-100 hover:border-blue-400 hover:shadow-2xl transition-all duration-500 animate-slide-in-right" style={{ animationDelay: "200ms" }}>
...
//         <div className="glass-effect p-8 rounded-[2rem] border-2 border-amber-100 shadow-lg flex items-center gap-6 group hover:-translate-y-3 hover:shadow-2xl hover:border-amber-300 transition-all duration-500 animate-slide-up" style={{ animationDelay: "300ms" }}>
...
//         <div className="glass-effect p-8 rounded-[2rem] border-2 border-amber-100 shadow-lg flex items-center gap-6 group hover:-translate-y-3 hover:shadow-2xl hover:border-amber-300 transition-all duration-500 animate-slide-up" style={{ animationDelay: "400ms" }}>
//           <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 rounded-full flex items-center justify-center shrink-0 group-hover:scale-125 group-hover:rotate-12 transition-all duration-500">
...
//   {/* WAVE AT BOTTOM - UNIQUE GRADIENT ID */}
//   <div className="absolute bottom-0 left-0 w-full pointer-events-none">
//     <svg className="w-full" viewBox="0 0 1440 100" preserveAspectRatio="none" style={{ display: "block", height: "100px" }}>
...
//     <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-8 animate-zoom-in shadow-xl">
...
//     <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-6 leading-tight animate-fade-in-up" style={{ fontFamily: "Poppins", animationDelay: "100ms" }}>
//       Ready to <span className="bg-gradient-to-r from-amber-800 via-yellow-300 to-amber-600 bg-clip-text text-transparent animate-gradient-flow bg-[length:200%_auto]">Get Started</span>?
//     </h2>

//     <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed font-medium animate-fade-in-up" style={{ fontFamily: "Inter", animationDelay: "200ms" }}>
      ...
      >
        ...
        <div className="max-w-7xl w-full px-6 sm:px-12 relative z-10 py-12">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className={`flex flex-col items-center gap-2 mb-20 ${isVisible ? "animate-fade-in" : "opacity-0"}`} style={{ animationDelay: "0.5s" }}>
              <button onClick={() => scrollToSection("what-is-dla")} aria-label="Scroll down" className="text-blue-600 hover:text-amber-600 transition-colors flex flex-col items-center gap-1 group">
                <span className="text-md font-semibold" style={{ fontFamily: "Inter" }}>Scroll to explore</span>
                <ChevronDown size={30} className="animate-bounce group-hover:translate-y-1 transition-transform" />
              </button>
      ...
      <section id="what-is-dla" className="relative py-24 sm:py-32 overflow-hidden pb-0" style={{ background: "linear-gradient(to bottom, #e0f2fe 0%, #f0f9ff 50%, #e0f2fe 100%)" }}>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div 
              ref={card1Ref}
              className={`group glass-effect p-8 rounded-3xl border-2 border-white/50 hover:border-blue-300 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 scroll-animate-left ${card1Visible ? 'visible' : ''}`}
            >
              <div className="relative w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                <Shield className="w-8 h-8 text-white" strokeWidth={2.5} />
                <div className="absolute inset-0 bg-white/20 rounded-2xl animate-pulse"></div>
              </div>
            ...
            <div 
              ref={card2Ref}
              className={`group glass-effect p-8 rounded-3xl border-2 border-white/50 hover:border-blue-300 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 scroll-animate ${card2Visible ? 'visible' : ''}`}
            >
              <div className="relative w-16 h-16 bg-gradient-to-br from-amber-600 to-orange-600 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
            ...
            <div 
              ref={card3Ref}
              className={`group glass-effect p-8 rounded-3xl border-2 border-white/50 hover:border-blue-300 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 scroll-animate-right ${card3Visible ? 'visible' : ''}`}
            >
              <div className="relative w-16 h-16 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-xl group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
